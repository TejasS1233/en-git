...
import { Copy, RefreshCw, Check, Eye, EyeOff, ExternalLink, AlertCircle, AlertTriangle } from "lucide-react";
  ...
  const fetchWebhookToken = async () => {
    try {
      ...
      const response = await axios.get(
        `${import.meta.env.VITE_API_BASE_URL}/webhook/token`,
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Add this token as a secret in your GitHub repository to enable automatic stats updates.
                </p>
                ...
                <AlertDialog open={showRegenerateDialog} onOpenChange={setShowRegenerateDialog}>
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This will invalidate your current token. Your GitHub Actions workflows will stop working until you update them with the new token.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                ...
                <Alert>
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>
                    Keep this token secret! Anyone with this token can trigger stats updates for your account.
                  </AlertDescription>
                </Alert>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  <p>1. Add <code className="bg-muted px-1 rounded">ENGIT_TOKEN</code> secret to your GitHub repo</p>
                  <p>2. Create workflow file: <code className="bg-muted px-1 rounded">.github/workflows/engit-stats.yml</code></p>
                  <p>3. Push and watch your stats auto-update! 🎉</p>
                </div>

                <Button
                  className="w-full gap-2"
                  onClick={() => window.open("https://github.com/TejasS1233/en-git/blob/main/.github/ADD_TO_YOUR_REPO.md", "_blank")}
                >
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2 border rounded-lg">
                ...
                >
                  ...
                  <svg className={`w-5 h-5 transition-transform ${expandedSections.primary ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-2 border rounded-lg">
                ...
                >
                  ...
                  <svg className={`w-5 h-5 transition-transform ${expandedSections.secondary ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
              ...
              <div className="space-y-2 border rounded-lg">
                ...
                >
                  ...
                  <svg className={`w-5 h-5 transition-transform ${expandedSections.accent ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
              ...
              <div className="space-y-2 border rounded-lg">
                ...
                >
                  ...
                  <svg className={`w-5 h-5 transition-transform ${expandedSections.base ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
              ...
              <div className="space-y-2 border rounded-lg">
                <button
                  ...
                  className="w-full flex items-center justify-between p-4 hover:bg-accent/50 transition-colors rounded-lg"
                >
                  <Label className="text-base font-semibold cursor-pointer">Card & Border Colors</Label>
                  <svg className={`w-5 h-5 transition-transform ${expandedSections.card ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
