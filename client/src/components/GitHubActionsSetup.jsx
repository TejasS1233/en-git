    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Automatically update your en-git stats after every push</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              your repository with this content:
            </p>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <code className="text-sm">
                ...
                <br />
                git commit -m "Add en-git stats tracking"
                <br />
                git push
              </code>
            </div>
          ...
          <div className="border-t pt-4">
            <Button
              ...
              onClick={() =>
                window.open(
                  "https://github.com/TejasS1233/en-git/blob/main/.github/GITHUB_ACTIONS_INTEGRATION.md",
                  "_blank"
                )
              }
            >
